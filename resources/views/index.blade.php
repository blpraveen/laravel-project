...
<div class="col-md-8 padding-20">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <p>Sampe Project to show work.</p>
                <p>Creating dashboard having navigation menu sidebar collapsable,header and footer.</p>
                <p>Admin Dashboard having three charts using HIGH Charts.</p>
            </div>
        </div>
